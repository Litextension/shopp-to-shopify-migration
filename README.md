...
=== Shopp to Shopify Migration Tool ===
Version: 2.4.1
Developed by: LitExtension

Download: https://litextension.com/shopify-migration/shopp-to-shopify-migration.html

== Description: Shopp to Shopify Migration Tool allows you to migrate your products, orders, customers and other data from Shopp to Shopify automatically.
